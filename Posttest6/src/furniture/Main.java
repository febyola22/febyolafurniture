        ...
        if(pil == 1){
           ...
           if (listmja.isEmpty()) {
                ...
                if(index <= listmja.size() || index > 0){
                    ...
                    System.out.print("Masukkan Nama       : ");
                    String nama = input.readLine();
                    listmja.get(index-1).setNama(nama);
                    
                    System.out.print("Masukkan Merk       : ");
                    String merk = input.readLine();
                    listmja.get(index-1).setMerk(merk);
                    
                    System.out.print("Masukkan Warna      : ");
                    String warna = input.readLine();
                    listmja.get(index-1).setWarna(warna);
                    ...
                    System.out.print("Masukkan Panjang    : ");
                    int panjang = Integer.parseInt(input.readLine());
                    listmja.get(index-1).setPanjang(panjang);
                    
                    System.out.print("Masukkan Harga      : ");
                    int harga = Integer.parseInt(input.readLine());
                    listmja.get(index-1).setHarga(harga);
